...
class IOnlineTaskService(ABC):
    ...
    @abstractmethod
    async def create_task(self, date: date, duration: int, type: TaskType, reward: int, url: str | None, title: str, description: str, is_for_members: bool, region: str | None = None) -> OnlineTask: ...
    @abstractmethod
